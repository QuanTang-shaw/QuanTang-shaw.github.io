	...
	(function () {
		...
		var oInput=document.querySelectorAll('input'),
			...
			// btn_add_R=oInput[1],
			// btn_sub_R=oInput[2],
			colorValue_G=oInput[1],
			// btn_add_G=oInput[4],
			// btn_sub_G=oInput[5],
			colorValue_B=oInput[2],
			// btn_add_B=oInput[7],
			// btn_sub_B=oInput[8],
			colorValue_H=oInput[3],
			// btn_add_H=oInput[4],
			// btn_sub_H=oInput[5],
			colorValue_S=oInput[4],
			// btn_add_S=oInput[7],
			// btn_sub_S=oInput[8],
			colorValue_L=oInput[5],
			// btn_add_L=oInput[10],
			// btn_sub_L=oInput[11],
			txt_colorValue=oInput[6],
			btn_setColor=oInput[7],
			btn_getColor=oInput[8];
